package com.anirban.foodjunction.activity
...
import com.anirban.foodjunction.R
...
class DashboardActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //set user details
        textViewcurrentUser.text=sharedPreferencess.getString("name","Anirban Roy")
        textViewMobileNumber.text="+91-"+sharedPreferencess.getString("mobile_number","9382217301")
